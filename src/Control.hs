...
handleEvent (Work (WS { mode = m, board = b, cursorPos = cp, editList = el })) (B.VtyEvent (V.EvKey V.KRight [])) = B.continue (Work (WS { mode = m, board = b, cursorPos = cursorRight cp, editList = el }))
handleEvent (Work (WS { mode = m, board = b, cursorPos = cp, editList = el })) (B.VtyEvent (V.EvKey V.KLeft [])) = B.continue (Work (WS { mode = m, board = b, cursorPos = cursorLeft cp, editList = el }))
handleEvent (Work (WS { mode = m, board = b, cursorPos = cp, editList = el })) (B.VtyEvent (V.EvKey V.KUp [])) = B.continue (Work (WS { mode = m, board = b, cursorPos = cursorUp cp, editList = el }))
handleEvent (Work (WS { mode = m, board = b, cursorPos = cp, editList = el })) (B.VtyEvent (V.EvKey V.KDown [])) = B.continue (Work (WS { mode = m, board = b, cursorPos = cursorDown cp, editList = el }))
...
handleEvent (Work (WS { mode = Edit, board = b, cursorPos = (y, x), editList = el })) (B.VtyEvent (V.EvKey (V.KChar 'd') [])) = B.continue (Work (WS { mode = Edit, board = M.setElem (C.setContent (M.getElem y x b) C.Empty) (y, x) b, cursorPos = (y, x), editList = el }))

handleEvent (Work (WS { mode = View, board = b, cursorPos = cp, editList = el })) (B.VtyEvent (V.EvKey (V.KChar 's') [])) = B.suspendAndResume $ do
                                                                                                                                                    writeFile "out.hgs" (show b)
